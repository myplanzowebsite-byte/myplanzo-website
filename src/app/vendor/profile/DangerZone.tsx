...
export function VendorDangerZone() {
  ...
  return (
    <section className="space-y-3 rounded-[var(--radius-mp-card)] border border-mp-accent/30 bg-mp-card p-6 shadow-[var(--shadow-mp-card)]">
      <div>
        <h2 className="text-sm font-semibold text-mp-accent">Delete vendor account</h2>
        <p className="text-xs text-mp-muted">
          Your business profile and listings are removed from the marketplace and you&apos;ll be
          signed out. Past booking and payment records are retained for the customers you served
          and platform accounting. This cannot be undone.
        </p>
      </div>
